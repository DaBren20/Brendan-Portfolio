...
const Projects = () => {
    return (
        <div className='projects'>
            ...
            <LongCard name="Portfolio Website" img={Portfolio} tools="Tools: NodeJS • React • Bootstrap *Deployed on Heroku* " alt="UberGains" description="This is my portfolio website (The website that you are on right now)" link="https://brendan-prosper-portfolio.herokuapp.com/" />
        </div>
    )
}
