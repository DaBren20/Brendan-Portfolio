...
const Projects = () => {
    return (
        <div className='projects'>
            ...
            <LongCard name="UberGains" img={Ubergains} alt="UberGains" description="This is a mock food delivery website that uses nodeJS as it's backend and Handlebars and bootstrap as the front end. This website also supports account creation and login capabilities. Admin accounts can create, remove, update, and delete products from the mongoDB database." link="https://brendanassignment3-5.herokuapp.com/" />
        </div>
    )
}
